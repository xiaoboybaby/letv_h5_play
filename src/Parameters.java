...
public class Parameters {
	...
	public Parameters gslb() {
		this.genrateParam(GSLB);
		return this;
	}
	
	public Parameters gslb2() {
		this.genrateParam(GSLB2);
		return this;
	}

	public Parameters cload() {
		this.genrateParam(CLOAD);
		return this;
	}

	public Parameters block() {
		this.genrateParam(BLOCK);
		return this;
	}

	public Parameters play() {
		this.genrateParam(PLAY);
		return this;
	}

	public Parameters time() {
	...
	public String toHttpParam() {
		String param = "";
		Object[] fieldsValues = getFiledValues(this);
		Map fieldsInfo = getFiledsInfo(this);
